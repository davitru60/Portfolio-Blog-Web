...
const HomeArticleCard = (blogCardProps: BlogCardProps) => {
  const { posts } = blogCardProps;


  return (
    <div
      className="grid grid-cols-1 gap-5 md:grid-cols-2 md:px-12 lg:grid-cols-3 lg:px-24"
    >
